...
import static top.anemone.mlsast.gui2.MainFrameHelper.attachAcceleratorKey;
import static top.anemone.mlsast.gui2.MainFrameHelper.newJMenuItem;
...
import top.anemone.mlsast.gui2.FilterListener.Action;
...
public class MainFrameMenu {
    ...
    public void initOSX() throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        osxAdapter = Class.forName("top.anemone.mlsast.gui2.OSXAdapter");
