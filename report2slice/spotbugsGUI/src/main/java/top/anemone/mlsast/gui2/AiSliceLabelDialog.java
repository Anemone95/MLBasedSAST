...
public class AiSliceLabelDialog extends JDialog {
    ...
    public AiSliceLabelDialog(JFrame parent, Logger l, boolean modal, Set<TaintFlow> flowEdges) {
        super(parent, modal);
        ...
        JButton safeBtn = new JButton(new AbstractAction("Labeled as Safe") {
            @Override
        ...
        JButton unsafeBtn = new JButton(new AbstractAction("Labeled as Unsafe") {
            @Override
            public void actionPerformed(ActionEvent evt) {
                TaintFlow edge = (TaintFlow) jcombo.getSelectedItem();
