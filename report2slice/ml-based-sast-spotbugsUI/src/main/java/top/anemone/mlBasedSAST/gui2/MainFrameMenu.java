...
import static top.anemone.mlBasedSAST.gui2.MainFrameHelper.attachAcceleratorKey;
import static top.anemone.mlBasedSAST.gui2.MainFrameHelper.newJMenuItem;
...
import top.anemone.mlBasedSAST.gui2.FilterListener.Action;
...
public class MainFrameMenu {
    ...
    JMenuBar createMainMenuBar() {
        ...
        recentMenu = MainFrameHelper.newJMenu("menu.recent_menu", "Recent");
        ...
        viewMenu = MainFrameHelper.newJMenu("menu.view_menu", "View");
        setViewMenu();
        ...
        if (!MainFrame.MAC_OS_X) {
            ...
            JMenuItem aboutItem = MainFrameHelper.newJMenuItem("menu.about_item", "About SpotBugs");
        ...
        AiListeners aiListeners=new AiListeners();
        JMenu aiMenu = MainFrameHelper.newJMenu("menu.ai_menu", "AI");
        JMenuItem serverItem = MainFrameHelper.newJMenuItem("menu.ai_server_item", "Set Server");
        aiMenu.add(serverItem);
        ...
        JMenuItem cleanDB = MainFrameHelper.newJMenuItem("menu.cleanDB", "Clean DB");
        aiMenu.add(cleanDB);
        cleanDB.addActionListener(evt -> aiListeners.cleanDB());
    ...
    public void initOSX() throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        osxAdapter = Class.forName("top.anemone.mlBasedSAST.gui2.OSXAdapter");
