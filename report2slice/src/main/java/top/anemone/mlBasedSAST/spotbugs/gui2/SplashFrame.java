...
public class SplashFrame extends JWindow {
    ...
    public SplashFrame() {
        ...
        Image image = toolkit.getImage(MainFrame.class.getClassLoader().getResource("SplashBug1.png"));
        Image image2 = toolkit.getImage(MainFrame.class.getClassLoader().getResource("SplashBug2B.png"));
        Image imageReverse = toolkit.getImage(MainFrame.class.getClassLoader().getResource("SplashBug1reverse.png"));
        Image image2Reverse = toolkit.getImage(MainFrame.class.getClassLoader().getResource("SplashBug2reverseB.png"));

        JLabel l = new JLabel(new ImageIcon(MainFrame.class.getClassLoader().getResource("spotbugs.png")));
        JPanel p = new JPanel();
