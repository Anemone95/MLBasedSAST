...
import static top.anemone.mlBasedSAST.gui2.MainFrameHelper.newJMenu;
...
public class MainFrameMenu {
    ...
    JMenuBar createMainMenuBar() {
        ...
        // TODO AI logic
        JMenu aiMenu = newJMenu("menu.ai_menu", "AI");
        JMenuItem serverItem = newJMenuItem("menu.ai_server_item", "Set Server");
        aiMenu.add(serverItem);
        serverItem.addActionListener(evt -> mainFrame.about());

        JMenuItem sliceAndPredictItem = newJMenuItem("menu.sliceAndPredict_item", "Slice And Predict");
        aiMenu.add(sliceAndPredictItem);
        sliceAndPredictItem.addActionListener(evt -> mainFrame.about());
